...
Position – Player role on the team (e.g., quarterback, running back, wide receiver, defensive player, punter).
Injury Designation – The type or location of the injury (e.g., knee, shoulder, concussion).
Defensive Play Type – Categorized types of defensive plays (e.g., sacks, interceptions, tackles).
Quantitative Variables:
Passing Yards & Attempts – Number of yards gained and attempts made (yards).
Rushing Yards & Attempts – Number of rushing yards and rushing attempts (yards).
Kicking Yards & Attempts – Total yards and attempts from punts or field goals (yards).
Height – Player height (feet).
Weight – Player weight (pounds).
Career Length – Total seasons played in the NFL (years).
Injury Duration – Number of games missed due to injury (equivalent to weeks).
Number of Observations
Each dataset contains between 8,000 and 80,000 entries. After data cleaning (removing null or NaN values), we anticipate retaining at least 1,000 high-quality observations suitable for analysis.
